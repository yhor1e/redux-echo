...
var actionCreaterEcho = function actionCreaterEcho(val) {
  return {
    type: 'DO_ECHO',
    index: 1,
    val: val
...
exports.default = actionCreaterEcho;
...
var _actionCreaterEcho = require('./action-creater-echo');

var _actionCreaterEcho2 = _interopRequireDefault(_actionCreaterEcho);

var _reducerEcho = require('./reducer-echo');

var _reducerEcho2 = _interopRequireDefault(_reducerEcho);

function _interopRequireDefault(obj) {
  return obj && obj.__esModule ? obj : { default: obj };
}

var store = (0, _redux.createStore)(_reducerEcho2.default);
...
document.getElementById('echoBtn').addEventListener('click', function () {
  store.dispatch((0, _actionCreaterEcho2.default)(document.getElementById('inputedVal').value));
});

},{"./action-creater-echo":22,"./reducer-echo":24,"redux":17}],24:[function(require,module,exports){
'use strict';
...
// redux reducer
var reducerEcho = function reducerEcho() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'initail state';
  var action = arguments[1];
